...
function getAppSettings() {
  ...
  try {
    ...
    if (fs.existsSync(settingsPath)) {
      ...
      cachedSettings = {
        ...
        rlControllerSkin: s.rlControllerSkin ?? 'ps4_white',
        rlControllerUrl: s.rlControllerUrl ?? 'https://gamepadviewer.com/?p=1&s=8',
  ...
  cachedSettings = {
    ...
    rlControllerSkin: 'ps4_white' as const, rlControllerUrl: 'https://gamepadviewer.com/?p=1&s=8', rlControllerScale: 80,
